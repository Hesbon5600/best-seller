...
AUT_01 = Error(
    code="AUT_01", message="Authorization code is empty", _status=400)
...
# User's Errors
USR_01 = Error(
    code="USR_01", message="Email or Password is invalid", _status=400)
USR_02 = Error(
    code="USR_02", message="This field is required", _status=400)
USR_03 = Error(code="USR_03", message="The email is invalid",
               _status=400, field='email')
USR_04 = Error(code="USR_04", message="The email already exists",
               _status=400, field='email')
USR_05 = Error(code="USR_05", message="The email doesn't exist",
               _status=404, field='email')
USR_06 = Error(code="USR_06", message="This is an invalid phone number",
               _status=400, field='phone')
USR_07 = Error(code="USR_07", message=" is too long", _status=400)
USR_08 = Error(code="USR_08", message="This is an invalid Credit Card",
               _status=400, field='credit_card')
...
# Category's Errors
CAT_01 = Error(
    code="CAT_01", message="Don't exist category with this ID", _status=404)

# Department's Errors
DEP_01 = Error(code="DEP_01", message="The ID is not a number",
               _status=400, field='id')
DEP_02 = Error(
    code="DEP_02", message="Don'exist department with this ID.", _status=404)

# Product's Errors
PRO_01 = Error(
    code="PRO_01", message="Don't exist product with this ID", _status=404)
...
SHP_01 = Error(
    code="ORD_01", message="Don't exist shoppingCart with this cart_id", _status=404)
