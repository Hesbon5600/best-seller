...
from turing_backend.authentication.token import generate_token
...
class ProductSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ('product_id', 'name', 'description',
                  'price', 'discounted_price', 'thumbnail', 'image', 'image_2')
...
class LoginSerializer(serializers.Serializer):
    ...
    def to_representation(self, data):
        ...
        # we pass `email` as the `name` value. Remember that, in our User
