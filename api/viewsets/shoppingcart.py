...
from api.serializers import ShoppingcartSerializer, ProductSerializer, UpdateShoppingcartSerializer
from api.validators import validate_shopping_cart_input, validate_cart_ids, validate_field_required
import logging
